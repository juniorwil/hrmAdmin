...
class Modulo1Controller extends AbstractActionController
{
    ...
    private $ttab = "Modulo padre, Modulo1, Opciones , Modificar,Quitar"; // Titulo de las columnas de la tabla
//    private $mod  = "Nivel de aspecto ,A,E"; // Funcion del modelo
    ...
    public function listAction()
    {
        ...
        (
            "titulo"    =>  $this->tlis,
            "datos"     =>  $u->getGeneral("Select a.nombre as nomMod, b.nombre, b.id  from c_mu a inner join c_mu1 b on a.id=b.idM
order by a.nombre, b.nombre"),            
   ...
   public function listiAction()
   {
      ...
      $valores=array
      (
           "titulo"    =>  'Conceptos tipo de automatico',
           "datos"     =>  $d->getGeneral("Select a.id, a.nombre , CONCAT( a.modelo ,'/', a.controlador ,'/', a.vista ) as link, b.nombre as nomgop 
                                           ...
                                           where a.idM1=".$id." order by a.nombre"),// Listado de formularios            
